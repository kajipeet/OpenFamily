import { _ as _sfc_main$4 } from "./UserAvatar-BjFy4kfy.js";
import { _ as __nuxt_component_0 } from "./nuxt-link-FLrwJPI1.js";
import { defineComponent, mergeProps, useSSRContext, ref, unref, withCtx, createTextVNode, watch } from "vue";
...
import { c as useChatStore, a as useAuthHeaders, u as useAuth, e as useCallStore, d as useWebSocket } from "./useAuth-CYq6jCny.js";
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="min-w-0 flex-1"><div class="flex items-center justify-between gap-2"><p class="text-white text-sm font-medium truncate">${ssrInterpolate(__props.chat.other_user?.display_name)}</p><span class="text-[11px] text-tg-gray whitespace-nowrap">${ssrInterpolate(formatTime(__props.chat.last_message_at))}</span></div><div class="flex items-center justify-between gap-2 mt-0.5"><p class="text-tg-gray text-xs truncate">${ssrInterpolate(__props.chat.last_message || "No messages yet")}</p>`);
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="min-w-0"><p class="text-white text-sm font-medium leading-tight truncate">${ssrInterpolate(unref(auth).user?.display_name)}</p><p class="text-tg-gray text-xs truncate">${ssrInterpolate(unref(auth).user?.tag)}</p></div></div><div class="flex items-center gap-1">`);
...
//# sourceMappingURL=default-B-Msk-3x.js.map
