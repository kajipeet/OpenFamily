import { _ as _sfc_main$1 } from "./UserAvatar-BjFy4kfy.js";
...
import { a as useAuthHeaders } from "./useAuth-CYq6jCny.js";
import "../server.mjs";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(loadingUsers)) {
        ...
        ssrRenderList(unref(users), (u) => {
          ...
          _push(`<div class="min-w-0"><p class="text-white text-sm font-medium truncate">${ssrInterpolate(u.display_name)}</p><p class="text-tg-gray text-xs truncate">${ssrInterpolate(u.tag)} · ${ssrInterpolate(u.role)}</p></div></div>`);
          if (u.id !== unref(auth).user?.id) {
...
//# sourceMappingURL=admin-CGF6lzix.js.map
