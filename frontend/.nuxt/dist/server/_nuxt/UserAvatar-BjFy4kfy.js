...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (__props.user?.avatar) {
        _push(`<img${ssrRenderAttr("src", __props.user.avatar)}${ssrRenderAttr("alt", __props.user?.display_name || __props.user?.username || "avatar")} class="w-full h-full object-cover">`);
      } else {
...
//# sourceMappingURL=UserAvatar-BjFy4kfy.js.map
